...
let agentArray = [ethan, jim, claire, eugene, franz, luther, sarah, max, hannah, jack, frank]
...
print("There have been \(compromisedAgents()) agents compromised! \n")
...
print("There are \(findCleanAgents().count) clean agents out of \(compromisedAgents() + findCleanAgents().count) agents \n")
...
func masterList() {
    let sortedArray = agentArray.sorted { $0.accessLevel < $1.accessLevel }
